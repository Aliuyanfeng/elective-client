<template>
  <div class="aside_container">
    <div class="timestamp">
      ...
      <p>距离选课结束还有</p>
      <p>{{residue.day}}天 {{residue.hour}}时 {{residue.min}}分{{residue.sec}}秒</p>
    </div>

    <h3>
      <i class="el-icon-document"></i> 最新动态:
    </h3>
    <ol class="newslist">
      <li>
        <a href>公共选修课补选2 哈尔滨信息工程学院-智慧树⽹学习手册a</a>
      </li>
      <li>
        <a href>公共选修课补选2 哈尔滨信息工程学院-智慧树⽹学习手册a</a>
      </li>
  ...
  methods: {
    ...
    residueTime() {
      const rtimer = setInterval(() => {
        ...
        var EndTime = new Date("2020/10/01 00:00:00");
